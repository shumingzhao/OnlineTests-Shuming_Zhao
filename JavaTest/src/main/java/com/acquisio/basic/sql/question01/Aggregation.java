...
//            H2DBUtil.displayTableRows(conn, "employees_projects");
            ...
            String query = "select a.title,count(b.id) from projects a left join employees_projects c on c.project_id = a.id left join employees b on b.id=c.employee_id where c.employee_id not null";
